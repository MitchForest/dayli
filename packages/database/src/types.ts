...
export type UserPattern = Database['public']['Tables']['user_patterns']['Row'];
export type UserPatternInsert = Database['public']['Tables']['user_patterns']['Insert'];
export type UserPatternUpdate = Database['public']['Tables']['user_patterns']['Update'];
